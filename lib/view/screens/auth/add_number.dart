              ...
              child: Column(
                children: [
                 ...
                 // const SizedBox(height: 4), // Space between dropdown and line
                  ...
                  //   validator: (value){
                  //  bool isValidated=   isValidPhoneNumber(value!);
                  //  return value!.isEmpty ||value==null?localizations.please_enter_phone:
                  //
                  //  isValidated==false?
                  //      localizations.enterValidPhone
                  //      : null;
    ...
    if (_formKey.currentState!.validate()) {
      if(_passwordController.text==_confirmPasswordController.text){
       ...
       //    Get.to(const VerifyNumber());
        Get.to( YourProfile(email: _emailController.text,password: _passwordController.text,confirmPassword: _confirmPasswordController.text,phone: _phoneNumberController.text,));
      }else{
