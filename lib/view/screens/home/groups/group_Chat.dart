...
class GroupChat extends StatefulWidget {
  Group current_group;
   GroupChat({super.key,required this.current_group});
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                SizedBox(
                                  width: w * .8,
                                  height: h*.08,//25 / baseHeight) * h,//edit height
                                  child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return Padding(
                                          ...
                                          child: Column(
                                            children: [
                                              Text(members[index].name,overflow: TextOverflow.ellipsis,style: TextStyle(fontSize: w*.025,color: Colors.white),),
